  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-900 to-gray-800 text-white">
      <div className="w-full max-w-md bg-gray-900 p-12 rounded-[50px] shadow-2xl flex flex-col items-center border border-purple-600">
        <h1 className="text-4xl font-extrabold text-purple-300 mb-6">Reset Password</h1>
        <p className="text-lg text-gray-400 mb-8">Enter your email address to receive a password reset link.</p>
        ...
        <button
          className="w-full px-8 py-4 bg-purple-600 text-white text-lg font-medium rounded-full shadow-md transition duration-300 transform hover:scale-105 hover:bg-purple-500 mb-6"
